...
for (i=0;i<data.length;i++){
	flow_contents+='<div class="pathpart">';
	for (j=0;j<data[i].contents.length;j++){
		if (j==0){
			flow_contents+='<div class="stock"><div class="title toptitle"><p>'+data[i].contents[j].title+'</p>	</div><div class="contents"><p>Prospects: '+data[i].contents[j].Prospects+'</p><p>Bounce Rate: '+data[i].contents[j].BounceRate+'</p>	</div></div>';
		}else{
			flow_contents+='<div class="stock"><div class="title"><p>'+data[i].contents[j].title+'</p>	</div><div class="contents"><p>Prospects: '+data[i].contents[j].Prospects+'</p><p>Bounce Rate: '+data[i].contents[j].BounceRate+'</p>	</div></div>';
		}
	}
	flow_contents+='</div>';
}
